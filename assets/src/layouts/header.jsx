  ...
  return (
    <div className="flex justify-end items-center py-4">
      <div className="flex justify-center items-center">
        <span className="bg-red-700 rounded-full text-white text-lg px-2 m-0">
        ...
        <BsCart4
          ...
          className="text-lg w-10 h-10 m-0 cursor-pointer hover:text-gray-600 hover:-translate-y-1 duration-200"
        />
      </div>
      <BsSearch
