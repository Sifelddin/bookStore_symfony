...
export const Header = ({show , showBook , cartList}) => {
  ...
  return (
      ...
      <div className='flex items-center justify-between'>
       <div>
        {localStorageCart && <Link to={'/shipping'} className="underline text-gray-700 hover:text-black mx-2 p-1 uppercase"> shipping{">>"}</Link>}
        {localStorageOrder && <Link to={'/placeorder'} className="underline text-gray-700 hover:text-black mx-2 p-1 uppercase"> placeorder{">>"}</Link>}
      </div>
